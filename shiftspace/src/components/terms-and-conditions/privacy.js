    ...
    <div>
      ...
      <Container>
        <Grid columns={2} divided="vertically" stackable>
          ...
          <Grid.Row textAlign="right">
            <p>Last updated: October 23, 2022</p>
            <p>
          ...
          <div class="container">
            ...
            <ul>
              ...
              <li>
                ...
                "We", "Us" or "Our" in this Agreement) refers to ShiftSpace
                Financial Services CC, Windhoek, Namibia .
              </li>
              ...
              <li>
                <strong>Country</strong> refers to: Namibia
              </li>
              ...
              <li>
                <strong>Personal</strong> Data is any information that relates
              ...
              <li>
                <strong>Website</strong> refers to ShiftSpace Finance ,
                accessible from www.shiftfinance.m1.com.na
              </li>
          ...
          <div class="container">
            ...
            <ul>
              <li>By email: shiftfinance@m1.com.na</li>
              <li>
                By visiting this page on our website:
                <a href="https://www.shiftfinance.m1.com.na">
                  www.shiftfinance.m1.com.na
                </a>
              </li>
            </ul>
          </div>
